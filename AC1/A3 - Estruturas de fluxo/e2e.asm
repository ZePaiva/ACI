...
for:	# ciclo para imprimir  cada um dos 32 bits e identificar se estao ou nao ativos
	bge  i, 32,  endLoop	    # controla o ciclo
...
insideIf:  # continua apos teste da flag
	...
	beq  flag, $0, for	    	 # se flag = 0 e bit = 0, nao faz nada
